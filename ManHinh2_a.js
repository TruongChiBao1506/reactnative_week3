            ...
            <View style={{ flex: 1, width: 360, height: 640 }}>
                ...
                <View style={styles.Input}>
                    <View style={{flex:1, width:300, position:'relative'}}>
                        ...
                        <Image source={require('./image/avatar_user 1.png')} style={{ height: 32, width: 32, left: 10, top:5, position: 'absolute' }} />
                    </View>
                ...
                <View style={styles.Input}>
                    <View style={{flex:1, width:300, position:'relative'}}> 
                        ...
                        <Image source={require('./image/eye 2.png')} style={{height: 32, width: 32, right:30, top:5, position:'absolute'}} />
                    </View>
